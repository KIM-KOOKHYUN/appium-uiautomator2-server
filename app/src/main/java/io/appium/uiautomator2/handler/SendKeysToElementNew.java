 ...
 */
public class SendKeysToElementNew extends SafeRequestNewHandler {

    public SendKeysToElementNew(String mappedUri) {
        super(mappedUri);
    }
    ...
    protected AppiumResponse safeHandle(IHttpRequest request) throws UiObjectNotFoundException {
        ...
        if(request.uri().contains("element"))
            element = findAndroidElement(request);
        else
